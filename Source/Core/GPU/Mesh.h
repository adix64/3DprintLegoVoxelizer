...
class Mesh
{
	...
	public:
		...
		bool LoadMesh(const std::string& fileLocation, const std::string& fileName, float scale = 1.f);

		bool CreateMesh(const std::vector<VertexFormat> &verts, const std::vector<unsigned int> &indices);
